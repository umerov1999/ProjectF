...
object ImageProcessingUtilNative {
    ...
    fun getYUVImageVUOff(
        srcByteBufferV: ByteBuffer,
        srcByteBufferU: ByteBuffer
    ): Int {
        return nativeGetYUVImageVUOff(srcByteBufferV, srcByteBufferU)
    }

    fun newDirectByteBuffer(
        byteBuffer: ByteBuffer,
        offset: Int,
        capacity: Int
    ): ByteBuffer {
        return nativeNewDirectByteBuffer(byteBuffer, offset, capacity)
    }
    ...
    private external fun nativeGetYUVImageVUOff(
        srcByteBufferV: ByteBuffer,
        srcByteBufferU: ByteBuffer
    ): Int
     ...
     */
    private external fun nativeNewDirectByteBuffer(
        byteBuffer: ByteBuffer,
        offset: Int,
        capacity: Int
    ): ByteBuffer
